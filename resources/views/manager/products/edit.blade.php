...
<div class="w-full px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
        <div>
            <p class="text-sm text-gray-400 mb-2">Dashboard / Produk / Edit</p>
            <h1 class="text-4xl font-bold text-white">Edit Produk</h1>
            <p class="text-gray-400 mt-2">Perbarui informasi produk yang sudah ada.</p>
        </div>
        ...
        <form action="{{ route('manager.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-8">
                ...
                <div class="flex flex-col items-center mb-8">
                    @if($product->gambar)
                    <img id="preview-image" src="{{ asset('storage/'.$product->gambar) }}"
                        class="w-48 h-48 rounded-xl object-cover border-4 border-gray-700 shadow-lg">
                    @else
                    <img id="preview-image" src="https://placehold.co/300x300/1F2937/FFFFFF?text=No+Image"
                        class="w-48 h-48 rounded-xl object-cover border-4 border-gray-700 shadow-lg">
                    @endif
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block mb-2 text-gray-300 font-semibold">Stok</label>
                ...
                <div class="mt-6">
                    <label class="block mb-2 text-gray-300 font-semibold">Ganti Foto Produk</label>
