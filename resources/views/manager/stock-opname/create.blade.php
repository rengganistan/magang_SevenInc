                ...
                <table class="min-w-full" id="opnameTable">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-700/50 opname-row">
                            ...
                            <td class="px-6 py-4 text-gray-400 text-sm">{{ $product->category->nama ?? '-' }}</td>
                            <td class="px-6 py-4 text-center">
                                <span class="text-white font-semibold" data-stok="{{ $product->stok }}">{{ $product->stok }}</span>
                                <span class="text-gray-400 text-xs ml-1">{{ $product->satuan }}</span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <input type="number" name="stok_fisik[{{ $product->id }}]" min="0"
                            ...
                            <td class="px-6 py-4 text-center">
                                <span class="selisih-badge px-3 py-1 rounded-full text-sm font-semibold bg-gray-600/30 text-gray-400">0</span>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
