...
<div class="w-full px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
        ...
        <a href="{{ $type === 'Masuk' ? route('manager.transactions.incoming') : route('manager.transactions.outgoing') }}"
        ...
        <form action="{{ route('manager.transactions.store') }}" method="POST">
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block mb-2 text-gray-300 font-semibold">Status</label>
                        <select name="status"
                            class="w-full rounded-xl border border-gray-600 bg-gray-700 text-white px-4 py-3">
                            @if($type === 'Masuk')
